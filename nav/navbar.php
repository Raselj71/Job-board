...
<body>
     <nav class="navbar">
        <h2 class="title">JOB <span class="second-title">Board</span></h2>
        <ul class="list">
            <li><a href="/webpro/index.php">Home</a></li>
            <li class="dropdown">
            ...
            <li id="post-job"><a href="/webpro/admin/index.php">POST A JOB</a></li>
            <?php if (isset($_SESSION['id'])): ?>
                <li><a href="/webpro/logout.php">Logout</a></li>
            <?php else: ?>
                <li><a href="/webpro/login.php">Login</a></li>
            <?php endif; ?>
        </ul>
    </nav>
</body>
